...
public class NavigationDrawerFragment extends Fragment {
    ...
    public void setUp(int fragmentId, DrawerLayout drawerLayout, final Toolbar toolbar) {
        ...
        mDrawerToogle = new ActionBarDrawerToggle(getActivity(), drawerLayout, toolbar, R.string.drawer_open, R.string.drawer_close) {
            ...
            public void onDrawerOpened(View drawerView) {
                ...
                getActivity().invalidateOptionsMenu();  //actionbar ti še enkrat nariše
            }
    ...
    public static void saveToPreferences(Context context, String preferenceName, String preferenceValue) {
        ...
        editor.apply(); //apply je hitrejši od commita, in ti ne vrne če je shranlo al pa ne, commit maš pa waitingtime
    }
